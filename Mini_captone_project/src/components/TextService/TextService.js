        ...
        return (
            <div>
                <div className="service-container">
                    <h1 className="service-title-content">
                        Giá dịch vụ của SmartCity
                    </h1>
                    <div className="service-content">
                        <div className="service1-content">
                            ...
                            <div>
                                ...
                                _Theo giờ: 50.000vnđ/Giờ<br />
                                _Theo người: 50.000vnđ/Người<br /><br />
                            </div>
                        </div>
                        <div className="service2-content">
                            ...
                            <div>
                                ...
                                _Theo giờ: 50.000vnđ/Giờ<br />
                                _Theo người: 30.000vnđ/Người<br /><br />
                            </div>
                        </div>
                        <div className="service3-content">
                            ...
                            <div>
                                ...
                                _Theo giờ: 100.000vnđ/Giờ<br />
                                _Theo người: 50.000vnđ/Người<br />
                            </div>
                        </div>
                    </div>
